...
return {
	enter = function(self, from, songNum, songAppend)
		...
		static = love.filesystem.load("sprites/powerdown/static.lua")()
	...
	load = function(self)
		...
		faceWeeks:setupCountdown()
	end,

	initUI = function(self)
		faceWeeks:initUI()

		faceWeeks:generateNotes(love.filesystem.load("charts/powerdown/powerdown.lua")())
