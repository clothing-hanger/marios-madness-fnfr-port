...
return graphics.newSprite(
	...
	},
	{
		...
		["alone"] = {start = 3, stop = 3, speed = 0, offsetX = 0, offsetY = 0},
		["alone"] = {start = 4, stop = 4, speed = 0, offsetX = 0, offsetY = 0},
		["golden land bf"] = {start = 5, stop = 5, speed = 0, offsetX = 0, offsetY = 0},
		["golden land bf losing"] = {start = 6, stop = 6, speed = 0, offsetX = 0, offsetY = 0},
		["golden land"] = {start = 7, stop = 7, speed = 0, offsetX = 0, offsetY = 0},
		["golden land losing"] = {start = 8, stop = 8, speed = 0, offsetX = 0, offsetY = 0},
		["i hate you"] = {start = 9, stop = 9, speed = 0, offsetX = 0, offsetY = 0},
		["i hate you losing"] = {start = 10, stop = 10, speed = 0, offsetX = 0, offsetY = 0},
		["golden land"] = {start = 11, stop = 11, speed = 0, offsetX = 0, offsetY = 0},
		["golden land"] = {start = 12, stop = 12, speed = 0, offsetX = 0, offsetY = 0},
		["its a me"] = {start = 13, stop = 13, speed = 0, offsetX = 0, offsetY = 0},
		["its a me losing"] = {start = 14, stop = 14, speed = 0, offsetX = 0, offsetY = 0},
		["golden land"] = {start = 15, stop = 15, speed = 0, offsetX = 0, offsetY = 0},
		["boyfrined losing (old)"] = {start = 16, stop = 16, speed = 0, offsetX = 0, offsetY = 0},
		["girlfriend"] = {start = 17, stop = 17, speed = 0, offsetX = 0, offsetY = 0},
		["powerdown"] = {start = 18, stop = 18, speed = 0, offsetX = 0, offsetY = 0},
		["powerdown losing"] = {start = 19, stop = 19, speed = 0, offsetX = 0, offsetY = 0},
		["apparition"] = {start = 20, stop = 20, speed = 0, offsetX = 0, offsetY = 0},
		["apparition losing"] = {start = 21, stop = 21, speed = 0, offsetX = 0, offsetY = 0},
